          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-left">
              ...
              <p className="text-lg text-text-secondary">
                Don't leave your security to chance. Our consultants work as an
                extension of your team to build a resilient, proactive defense
                posture tailored to your unique business environment.
              </p>
            </div>
            <div className="relative aspect-square rounded-full overflow-hidden shadow-lg animate-fade-in-right bg-teal-900/30 flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {[
              ...
              <div
                key={step.title}
                className="relative flex flex-col items-center text-center p-6 bg-background rounded-lg border-2 border-border-color z-10"
              >
