        ...
        <AnimateOnScroll animationClass="animate-fade-in-up">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="cursor-target relative aspect-video rounded-xl overflow-hidden shadow-lg">
                <Image
              ...
              <div className="cursor-target">
                ...
                <p className="text-lg text-text-secondary mb-6">
                  Your website is a critical asset. Our management services
                  ensure it remains secure, fast, and up-to-date, so you can
