  ...
  return (
    <section className="py-20 bg-background-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-12 animate-fade-in-up">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2 rounded-full bg-background-tertiary/50 hover:bg-background-tertiary/80 transition-colors duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary"
            >
              <svg
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-opacity duration-300 ease-in-out ${
